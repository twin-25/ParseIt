...
function IngestPanel({ sessionId }) {
  ...
  <div className="h-screen bg-surface flex flex-col relative">
    ...
    {/* Form section - natural size, no flex-1 */}
    <div className="p-6 flex flex-col gap-4">
      <textarea
        className="w-full h-32 border border-border rounded-lg p-3 text-text resize-none focus:outline-none focus:ring-2 focus:ring-primary"
    ...
    {/* DocList - takes remaining space, scrolls internally */}
